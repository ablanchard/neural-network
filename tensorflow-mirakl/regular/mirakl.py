...
"""DNNRegressor with custom input_fn for Mirakl dataset."""
...
COLUMNS = ["original_price", "quantity", "order"]
FEATURES = ["original_price", "quantity"]
LABEL = "order"
...
def main(unused_argv):
  # Load datasets
  training_set = pd.read_csv("mirakl_train.csv", skipinitialspace=True,
